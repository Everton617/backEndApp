...
public class SecurityConfig {
    ...
    @Autowired
    private CustomCandidatoDetailsService userDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/auth/company/login").permitAll()
                        .requestMatchers(HttpMethod.POST, "/auth/company/register").permitAll()
